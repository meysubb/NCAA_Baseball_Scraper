...
if (scrapersettings.map_players == 1) or (scrapersettings.summary_players == 1) or (scrapersettings.summary_teams == 1):
    ...
    for value, team in enumerate(team_mapping): # For each team in our dictionary
        ...
        # Get Pitching Data
	    pitching_roster_url = str(scrapersettings.domain_base) + "/team/" + team + "/stats?id=" + str(scrapersettings.year_index) + "&year_stat_category_id=10947" 
        ...
        for rownum, raw in enumerate(pitching_stat_grid[0].find('tbody').findAll('tr')):
            ...
            pit_H = str(pit_tds[11].get_text().encode('utf-8').strip())
            pit_R = str(pit_tds[12].get_text().encode('utf-8').strip())
            pit_ER = str(pit_tds[13].get_text().encode('utf-8').strip())
            pit_BB = str(pit_tds[14].get_text().encode('utf-8').strip())
            pit_SO = str(pit_tds[15].get_text().encode('utf-8').strip()) 
            pit_SHO = str(pit_tds[16].get_text().encode('utf-8').strip())
            pit_BF = str(pit_tds[17].get_text().encode('utf-8').strip())
            pit_POAB = str(pit_tds[18].get_text().encode('utf-8').strip())
            pit_2BA = str(pit_tds[19].get_text().encode('utf-8').strip())
            pit_3BA = str(pit_tds[20].get_text().encode('utf-8').strip())
            pit_BK = str(pit_tds[21].get_text().encode('utf-8').strip())
            pit_HRA = str(pit_tds[22].get_text().encode('utf-8').strip())
            pit_WP = str(pit_tds[23].get_text().encode('utf-8').strip())
            pit_HB = str(pit_tds[24].get_text().encode('utf-8').strip())
            pit_IBB = str(pit_tds[25].get_text().encode('utf-8').strip())
            pit_Inh_Run = str(pit_tds[26].get_text().encode('utf-8').strip())
            pit_SHA = str(pit_tds[28].get_text().encode('utf-8').strip())
            pit_SFA = str(pit_tds[29].get_text().encode('utf-8').strip())
            pit_Pitches = str(pit_tds[30].get_text().encode('utf-8').strip())
            pit_GO = str(pit_tds[31].get_text().encode('utf-8').strip())
            pit_FO = str(pit_tds[32].get_text().encode('utf-8').strip())
            pit_W = str(pit_tds[33].get_text().encode('utf-8').strip())
            pit_L = str(pit_tds[34].get_text().encode('utf-8').strip())
            pit_SV = str(pit_tds[35].get_text().encode('utf-8').strip())
            pit_KL = str(pit_tds[36].get_text().encode('utf-8').strip())
       ...
       # Get Pitching Team Data
        ...
        pit_team_H = str(pit_team_tds[11].get_text().encode('utf-8').strip())
        pit_team_R = str(pit_team_tds[12].get_text().encode('utf-8').strip())
        pit_team_ER = str(pit_team_tds[13].get_text().encode('utf-8').strip())
        pit_team_BB = str(pit_team_tds[14].get_text().encode('utf-8').strip())
        pit_team_SO = str(pit_team_tds[15].get_text().encode('utf-8').strip())
        pit_team_SHO = str(pit_team_tds[16].get_text().encode('utf-8').strip())
        pit_team_BF = str(pit_team_tds[17].get_text().encode('utf-8').strip())
        pit_team_POAB = str(pit_team_tds[18].get_text().encode('utf-8').strip())
        pit_team_2BA = str(pit_team_tds[19].get_text().encode('utf-8').strip())
        pit_team_3BA = str(pit_team_tds[20].get_text().encode('utf-8').strip())
        pit_team_BK = str(pit_team_tds[21].get_text().encode('utf-8').strip())
        pit_team_HRA = str(pit_team_tds[22].get_text().encode('utf-8').strip())
        pit_team_WP = str(pit_team_tds[23].get_text().encode('utf-8').strip())
        pit_team_HB = str(pit_team_tds[24].get_text().encode('utf-8').strip())
        pit_team_IBB = str(pit_team_tds[25].get_text().encode('utf-8').strip())
        pit_team_SHA = str(pit_team_tds[28].get_text().encode('utf-8').strip())
        pit_team_SFA = str(pit_team_tds[29].get_text().encode('utf-8').strip())
        pit_team_GO = str(pit_team_tds[31].get_text().encode('utf-8').strip())
        pit_team_FO = str(pit_team_tds[32].get_text().encode('utf-8').strip())
        pit_team_KL = str(pit_team_tds[36].get_text().encode('utf-8').strip())
       ...
       # Get Pitching Opposing Team Data  
        ...
        opp_pit_team_H = str(opp_pit_team_tds[11].get_text().encode('utf-8').strip())
        opp_pit_team_R = str(opp_pit_team_tds[12].get_text().encode('utf-8').strip())
        opp_pit_team_ER = str(opp_pit_team_tds[13].get_text().encode('utf-8').strip())
        opp_pit_team_BB = str(opp_pit_team_tds[14].get_text().encode('utf-8').strip())
        opp_pit_team_SO = str(opp_pit_team_tds[15].get_text().encode('utf-8').strip())
        opp_pit_team_SHO = str(opp_pit_team_tds[16].get_text().encode('utf-8').strip())
        opp_pit_team_BF = str(opp_pit_team_tds[17].get_text().encode('utf-8').strip())
        opp_pit_team_POAB = str(opp_pit_team_tds[18].get_text().encode('utf-8').strip())
        opp_pit_team_2BA = str(opp_pit_team_tds[19].get_text().encode('utf-8').strip())
        opp_pit_team_3BA = str(opp_pit_team_tds[20].get_text().encode('utf-8').strip())
        opp_pit_team_BK = str(opp_pit_team_tds[21].get_text().encode('utf-8').strip())
        opp_pit_team_HRA = str(opp_pit_team_tds[22].get_text().encode('utf-8').strip())
        opp_pit_team_WP = str(opp_pit_team_tds[23].get_text().encode('utf-8').strip())
        opp_pit_team_HB = str(opp_pit_team_tds[24].get_text().encode('utf-8').strip())
        opp_pit_team_IBB = str(opp_pit_team_tds[25].get_text().encode('utf-8').strip())
        opp_pit_team_SHA = str(opp_pit_team_tds[28].get_text().encode('utf-8').strip())
        opp_pit_team_SFA = str(opp_pit_team_tds[29].get_text().encode('utf-8').strip())
        opp_pit_team_GO = str(opp_pit_team_tds[31].get_text().encode('utf-8').strip())
        opp_pit_team_FO = str(opp_pit_team_tds[32].get_text().encode('utf-8').strip())
        opp_pit_team_KL = str(opp_pit_team_tds[36].get_text().encode('utf-8').strip()) 
